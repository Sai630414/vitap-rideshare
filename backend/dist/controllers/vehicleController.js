...
exports.deleteVehicle = exports.getMyVehicles = exports.registerVehicle = void 0;
...
const deleteVehicle = async (req, res, next) => {
    try {
        ...
        if (activeRide) {
            return next(new appError_1.default('Cannot delete a vehicle that has scheduled or ongoing rides', 400));
        }
